...
<script>
    ...
    function delauthor() {
        ...
        if (author_ids === "") {
            ...
            if (confirm("确定删除么?")) {
                //调用后台,执行删除操作
                window.location.href = "deleteAuthors?author_ids=" + news_ids + "&&admin_id=" + ${userMessage};
            }
        }

    }
</script>
<body background="Img_20200110_101518.jpg">
<div align="center">
    <h2>作者信息管理系统</h2>
    <input type="button" value="新增作者">
    <input type="button" value="删除作者">
    <input type="button" value="新增新闻" onclick="addNews()">
    <input type="button" value="编辑新闻" onclick="editNews()">
    <input type="button" value="删除新闻" onclick="delNews()">
</div>
<div>
    ...
    <table>
        ...
        <c:forEach items="${newsList}" var="news">
            <tr>
                <td align="center"><input type="checkbox" value="${news.newsId}" name="chk" onclick="unCheck(this)">
                </td>
