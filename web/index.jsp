...
<div>
    <div class="index-sm-location">
        <div class="index-search-box">
            <input class="index-search-txt" type="text" id="search_title" value="${searchText}" placeholder="输入搜索内容" onchange="getInputValue()">
            <a class="index-search-btn" id="press_to_search">
